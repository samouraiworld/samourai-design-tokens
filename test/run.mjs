...
//             colour maths the contrast gate rests on, and the control rings
//
...
const gates = [
  ...
  ['units', ['--test', '--test-reporter=spec', 'test/token-test.selftest.mjs', 'test/css-parity.selftest.mjs', 'test/color-math.selftest.mjs', 'test/control-selection-ring.selftest.mjs']],
];
